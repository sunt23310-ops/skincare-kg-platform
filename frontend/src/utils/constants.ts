    ...
    subTabs: [
      ...
      },
      {
        ...
        columns: [
          ...
          { prop: 'category', label: '分类', width: 120, type: 'tag' },
      ...
      },
      {
        key: 'budget',
        label: '预算档位',
        entityType: 'BudgetTier',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '档位名称', width: 140, sortable: true },
          { prop: 'minPrice', label: '最低价(元)', width: 120, sortable: true },
          { prop: 'maxPrice', label: '最高价(元)', width: 120, sortable: true },
          { prop: 'description', label: '描述' },
        ],
      },
      {
        ...
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '场景名称', width: 140, sortable: true },
          { prop: 'code', label: '编码', width: 100 },
          { prop: 'triggerCondition', label: '触发条件', width: 200 },
          { prop: 'description', label: '描述' },
        ],
      },
    ],
    ...
    subTabs: [
      {
        ...
        columns: [
          ...
          { prop: 'country', label: '国家/地区', width: 100, type: 'tag' },
          { prop: 'tier', label: '定位', width: 80, type: 'tag' },
          { prop: 'status', label: '状态', width: 80, type: 'status' },
        ],
      },
      {
        ...
        columns: [
          ...
          { prop: 'brand', label: '品牌', width: 120, type: 'link' },
      ...
      },
      {
        key: 'category-order',
        label: '品类顺序',
        entityType: 'CategoryOrder',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '品类名称', width: 140, sortable: true },
          { prop: 'sortOrder', label: '排序', width: 80, sortable: true },
          { prop: 'parentCategory', label: '父品类', width: 120 },
          { prop: 'description', label: '描述' },
        ],
      },
    ],
    ...
    subTabs: [
      {
        ...
        columns: [
          ...
          { prop: 'labelEn', label: '英文名(INCI)', width: 200 },
          { prop: 'category', label: '分类', width: 120, type: 'tag' },
          { prop: 'safetyLevel', label: '安全等级', width: 100, type: 'tag' },
          { prop: 'maxConcentration', label: '最高浓度', width: 100 },
          { prop: 'status', label: '状态', width: 80, type: 'status' },
        ],
      },
      {
        ...
        columns: [
          ...
          { prop: 'category', label: '分类', width: 120, type: 'tag' },
          { prop: 'evidenceLevel', label: '证据等级', width: 100, type: 'tag' },
          { prop: 'description', label: '描述' },
        ],
      },
      {
        ...
        columns: [
          ...
          { prop: 'bodyPart', label: '部位', width: 100, type: 'tag' },
          { prop: 'severity', label: '严重程度', width: 100, type: 'tag' },
          { prop: 'description', label: '描述' },
        ],
      },
      {
        ...
        columns: [
          ...
          { prop: 'severity', label: '严重程度', width: 100, type: 'tag' },
          { prop: 'triggerType', label: '触发类型', width: 120, type: 'tag' },
          { prop: 'description', label: '描述' },
        ],
      },
    ],
    ...
    subTabs: [
      {
        ...
        columns: [
          ...
          { prop: 'targetConcern', label: '目标诉求', width: 140, type: 'tag' },
          { prop: 'skinType', label: '适用肤质', width: 120, type: 'tag' },
          { prop: 'stepCount', label: '步骤数', width: 80, sortable: true },
          { prop: 'status', label: '状态', width: 80, type: 'status' },
        ],
      },
      {
      ...
      },
      {
        key: 'makeup-tutorial',
        label: '妆教方案',
        entityType: 'MakeupTutorial',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '方案名称', width: 200, sortable: true },
          { prop: 'category', label: '分类', width: 120, type: 'tag' },
          { prop: 'difficulty', label: '难度', width: 80, type: 'tag' },
          { prop: 'stepCount', label: '步骤数', width: 80, sortable: true },
          { prop: 'status', label: '状态', width: 80, type: 'status' },
        ],
      },
    ...
    subTabs: [
      {
        key: 'intent-tree',
        label: '意图树',
        entityType: 'IntentNode',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '意图名称', width: 160, sortable: true },
          { prop: 'parentIntent', label: '父意图', width: 140, type: 'link' },
          { prop: 'depth', label: '层级', width: 60, sortable: true },
          { prop: 'examples', label: '示例话术', width: 280 },
          { prop: 'status', label: '状态', width: 80, type: 'status' },
        ],
      },
      {
        key: 'signal-word',
        label: '路由信号词',
        entityType: 'SignalWord',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '信号词', width: 140, sortable: true },
          { prop: 'targetIntent', label: '目标意图', width: 160, type: 'link' },
          { prop: 'weight', label: '权重', width: 80, sortable: true },
          { prop: 'context', label: '上下文条件', width: 200 },
        ],
      },
      {
        key: 'follow-up',
        label: '追问策略',
        entityType: 'FollowUpStrategy',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '策略名称', width: 160, sortable: true },
          { prop: 'triggerIntent', label: '触发意图', width: 140, type: 'link' },
          { prop: 'questionTemplate', label: '追问模板', width: 280 },
          { prop: 'priority', label: '优先级', width: 80, sortable: true },
        ],
      },
    ],
    ...
    subTabs: [
      {
        ...
        columns: [
          ...
          { prop: 'synonyms', label: '同义词列表', width: 300 },
          { prop: 'targetEntity', label: '映射实体', width: 140, type: 'link' },
          { prop: 'status', label: '状态', width: 80, type: 'status' },
        ],
      },
      {
        key: 'negation',
        label: '否定模式',
        entityType: 'NegationPattern',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '否定模式', width: 200, sortable: true },
          { prop: 'pattern', label: '正则表达式', width: 240 },
          { prop: 'scope', label: '作用范围', width: 120, type: 'tag' },
          { prop: 'examples', label: '示例', width: 200 },
        ],
      },
      {
        key: 'ambiguity',
        label: '歧义词',
        entityType: 'AmbiguousWord',
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '歧义词', width: 140, sortable: true },
          { prop: 'senses', label: '义项列表', width: 280 },
          { prop: 'disambiguationRule', label: '消歧规则', width: 240 },
        ],
      },
      {
        key: 'hotword',
        ...
        columns: [
          { prop: 'id', label: 'ID', width: 80 },
          { prop: 'label', label: '热词', width: 140, sortable: true },
          { prop: 'frequency', label: '频次', width: 80, sortable: true },
          { prop: 'trendScore', label: '趋势分', width: 100, sortable: true },
          { prop: 'source', label: '来源', width: 120, type: 'tag' },
          { prop: 'createdAt', label: '收录时间', width: 160, sortable: true },
        ],
      },
    ],
  },
